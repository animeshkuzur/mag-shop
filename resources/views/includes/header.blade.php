						...
						<div class="container">		
							...
							<div class="collapse navbar-collapse navHeaderCollapse">
								...
								<ul class="nav navbar-nav navbar-right">
									<li><a href="{{ url('/') }}#product" class="btn btn-lg">PRODUCTS</a></li>
									<li><a href="{{ url('/') }}#userspace" class="btn btn-lg">WALL</a></li>
									<li><a href="{{ url('/') }}#why" class="btn btn-lg ">WHY?</a></li>
									<li><a href="{{ url('/blog') }}" class="btn btn-lg">BLOG</a></li>
									<li><a href="{{ url('/') }}#team" class="btn btn-lg">TEAM</a></li>
									<li><a href="{{ url('/') }}#contact" class="btn btn-lg ">CONTACT</a></li>
